...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/remove.svg":[function(require,module,exports) {
module.exports = "/remove.363b32b2.svg";
},{}],"app.js":[function(require,module,exports) {
// make sure that all the DOM elements are loaded
document.addEventListener('DOMContentLoaded', onDOMLoaded); // declare handlers for DOM elements
...
function onDOMLoaded() {
  ...
  input = document.getElementById('input'); // an array to keep track of our todos

  todos = [];
  loadDB(); // add a new todo to the database every time the user hits enter
...
},{"./assets/remove.svg":"assets/remove.svg"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
